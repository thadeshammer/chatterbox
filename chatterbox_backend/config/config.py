...
class Config:
    ...
    LOGGING_CONFIG_FILE: str = os.getenv(
        "LOG_CFG", "./chatterbox_backend/logging_config_pytest.yaml"
    )
    ...
    TESTDB_USER_FILE_FALLBACK = "./secrets/chatterbox_backend/test_postgres_user.txt"
    TESTDB_PASSWORD_FILE_FALLBACK = "./secrets/chatterbox_backend/test_postgres_password.txt"
