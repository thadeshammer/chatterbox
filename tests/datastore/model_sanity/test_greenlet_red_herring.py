...
from datastore.entities.models import Board, Category, Comment, Post, User
...
async def test_greenlet_red_herring(async_session):
    ...
    # you. If you turn on DEBUG logging for SQLAlchemy (see datastore.py logging setup) you can
